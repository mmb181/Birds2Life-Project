...
public class CrowScaleRotate : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        scaleSlider = GameObject.Find("ScaleSlider4").GetComponent<Slider>();
        scaleSlider.minValue = scaleMinValue;
        scaleSlider.maxValue = scaleMaxValue;
        scaleSlider.onValueChanged.AddListener(ScaleSliderUpdate);

        rotateSlider = GameObject.Find("RotateSlider4").GetComponent<Slider>();
