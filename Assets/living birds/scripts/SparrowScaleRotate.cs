...
public class SparrowScaleRotate : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        scaleSlider = GameObject.Find("ScaleSlider3").GetComponent<Slider>();
        scaleSlider.minValue = scaleMinValue;
        scaleSlider.maxValue = scaleMaxValue;
        scaleSlider.onValueChanged.AddListener(ScaleSliderUpdate);

        rotateSlider = GameObject.Find("RotateSlider3").GetComponent<Slider>();
